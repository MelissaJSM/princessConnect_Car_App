...
public class MainKarylActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_karyl);
        ...
        img_face.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent motionEvent) {
                ...
                if (action == MotionEvent.ACTION_DOWN) {
                    ...
                    img_face.setImageResource(R.drawable.char_karyl_shy);
                    bt_emotion.setImageResource(R.drawable.char_emotion_shy);
                    Toast.makeText(MainKarylActivity.this, "그렇게도 배신자가 좋습니까?", Toast.LENGTH_SHORT).show();
        ...
        bt_internet.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent motionEvent) {
                ...
                if (action == MotionEvent.ACTION_DOWN) {
                    ...
                    img_face.setImageResource(R.drawable.char_karyl_internet);
                    bt_emotion.setImageResource(R.drawable.char_emotion_internet);
                    Toast.makeText(MainKarylActivity.this, "인터넷 버튼 선택", Toast.LENGTH_SHORT).show();
        ...
        bt_navi.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent motionEvent) {
                ...
                if (action == MotionEvent.ACTION_DOWN) {
                    ...
                    img_face.setImageResource(R.drawable.char_karyl_navi);
                    bt_emotion.setImageResource(R.drawable.char_emotion_navi);
                    Toast.makeText(MainKarylActivity.this, "네비게이션 버튼 선택", Toast.LENGTH_SHORT).show();
        ...
        bt_bluetooth.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent motionEvent) {
                ...
                if (action == MotionEvent.ACTION_DOWN) {
                    ...
                    img_face.setImageResource(R.drawable.char_karyl_bt);
                    bt_emotion.setImageResource(R.drawable.char_emotion_bluetooth);
                    Toast.makeText(MainKarylActivity.this, "블루투스 버튼 선택", Toast.LENGTH_SHORT).show();
        ...
        bt_musicplayer.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent motionEvent) {
                ...
                if (action == MotionEvent.ACTION_DOWN) {
                    ...
                    img_face.setImageResource(R.drawable.char_karyl_music);
                    bt_emotion.setImageResource(R.drawable.char_emotion_music);
                    Toast.makeText(MainKarylActivity.this, "뮤직플레이어 버튼 선택", Toast.LENGTH_SHORT).show();
        ...
        bt_geniemusic.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent motionEvent) {
                ...
                if (action == MotionEvent.ACTION_DOWN) {
                    ...
                    img_face.setImageResource(R.drawable.char_karyl_music);
                    bt_emotion.setImageResource(R.drawable.char_emotion_music);
                    Toast.makeText(MainKarylActivity.this, "지니뮤직 버튼 선택", Toast.LENGTH_SHORT).show();
        ...
        bt_dc.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent motionEvent) {
                ...
                if (action == MotionEvent.ACTION_DOWN) {
                    ...
                    img_face.setImageResource(R.drawable.char_karyl_dc);   // 디씨용 이미지 수정 필요
                    bt_emotion.setImageResource(R.drawable.char_emotion_noooo); // 디씨용 이미지 수정 필요
                    Toast.makeText(MainKarylActivity.this, "디씨 버튼 선택", Toast.LENGTH_SHORT).show();
        ...
        bt_youtube.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent motionEvent) {
                ...
                if (action == MotionEvent.ACTION_DOWN) {
                    ...
                    img_face.setImageResource(R.drawable.char_karyl_youtube);   // 유튜브용 이미지 수정 필요
                    Toast.makeText(MainKarylActivity.this, "유튜브 버튼 선택", Toast.LENGTH_SHORT).show();
        ...
        bt_twitch.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent motionEvent) {
                ...
                if (action == MotionEvent.ACTION_DOWN) {
                    ...
                    img_face.setImageResource(R.drawable.char_karyl_youtube);   // 트위치용 이미지 수정 필요
                    Toast.makeText(MainKarylActivity.this, "트위치 버튼 선택", Toast.LENGTH_SHORT).show();
        ...
        bt_setting.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent motionEvent) {
                ...
                //ACTION_DOWN = 버튼을 누르다
                if (action == MotionEvent.ACTION_DOWN) {
                    Toast.makeText(MainKarylActivity.this, "세팅 버튼 선택", Toast.LENGTH_SHORT).show();
                }
                else if (action == MotionEvent.ACTION_UP) {
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.fab1:
                ...
                Intent char_kokkoro = new Intent(MainKarylActivity.this, MainKokkoroActivity.class);
            ...
            case R.id.fab2:
                ...
                Intent char_karyl = new Intent(MainKarylActivity.this, MainKarylActivity.class);
            ...
            case R.id.fab3:
                ...
                Intent char_peco = new Intent(MainKarylActivity.this, MainPecoActivity.class);
            ...
            case R.id.fab4:
                ...
                Intent char_3tar = new Intent(MainKarylActivity.this, Karyl3starActivity.class);
    ...
    public void timerzone(){
        ...
        if(hour24>=20 || hour24<6){
            img_background.setImageResource(R.drawable.bg_500012); //밤
            System.out.println("지금 밤이래");
        }
        else if(hour24>=6 && hour24<16){
            img_background.setImageResource(R.drawable.bg_500010); //아침
            System.out.println("지금 아침이래");
        }
        else{
            img_background.setImageResource(R.drawable.bg_500011); //저녁
